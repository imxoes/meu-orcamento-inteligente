    ...
    <>
      ...
      >
        <div>
          ...
          <p className="text-zinc-300 font-medium">Gerencie suas finanças diretamente pelo WhatsApp</p>
        </div>
      </motion.div>
      ...
      {!whatsappLinked && (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold drop-shadow-lg text-white">Vincular Conta WhatsApp</h2>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold drop-shadow-lg rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {linkingWhatsApp ? (
                <>
      ...
      {whatsappLinked && (
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-bold drop-shadow-lg text-white">Informações do Bot</h2>
          </div>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-zinc-300 font-medium">Plataforma:</span>
              <span className="text-white font-bold drop-shadow-lg">WhatsApp</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-white font-bold drop-shadow-lg">{user?.whatsappId}</span>
            </div>
            <button
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold drop-shadow-lg text-white">Como Configurar o Bot</h2>
        </div>
        <div className="space-y-4">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-white font-bold drop-shadow-lg mb-1">Vincule sua conta</h3>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-white font-bold drop-shadow-lg mb-1">Envie uma mensagem</h3>
              <p className="text-zinc-300 font-medium text-sm">
          ...
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="text-white font-bold drop-shadow-lg mb-1">Comece a usar</h3>
              <p className="text-zinc-300 font-medium text-sm">
      ...
      >
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-bold drop-shadow-lg text-white">Como Utilizar o Bot</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            <DollarSign className="w-5 h-5 text-blue-400 mb-2" />
            <h3 className="text-white font-bold drop-shadow-lg mb-1">Registrar Receita</h3>
            <p className="text-zinc-300 font-medium text-sm mb-2">Ex: &quot;recebi 500 de salário&quot;</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <h3 className="text-white font-bold drop-shadow-lg mb-1">Registrar Despesa</h3>
            <p className="text-zinc-300 font-medium text-sm mb-2">Ex: &quot;gastei 50 em comida&quot;</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <h3 className="text-white font-bold drop-shadow-lg mb-1">Consultar Saldo</h3>
            <p className="text-zinc-300 font-medium text-sm mb-2">Ex: &quot;qual meu saldo?&quot;</p>
          ...
          <div className="bg-white/5 border border-white/10 rounded-lg p-4">
            ...
            <h3 className="text-white font-bold drop-shadow-lg mb-1">Consultar Metas</h3>
            <p className="text-zinc-300 font-medium text-sm mb-2">Ex: &quot;minhas metas&quot;</p>
      ...
      {whatsappLinked && (
        ...
        >
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-xl font-bold drop-shadow-lg text-white">Alertas Automáticos</h2>
          </div>
          <p className="text-zinc-300 font-medium mb-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-lg">
              <div>
                <h3 className="text-white font-bold drop-shadow-lg">Alertas de Gastos</h3>
                <p className="text-zinc-300 font-medium text-sm">Receba notificações quando seus gastos ultrapassarem limites definidos</p>
              </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-lg">
              <div>
                <h3 className="text-white font-bold drop-shadow-lg">Alertas de Metas</h3>
                <p className="text-zinc-300 font-medium text-sm">Receba notificações sobre o progresso das suas metas financeiras</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
            ...
            <div className="flex items-center justify-between p-4 bg-white/5 border border-white/10 rounded-lg">
              <div>
                <h3 className="text-white font-bold drop-shadow-lg">Alertas de Saldo Baixo</h3>
                <p className="text-zinc-300 font-medium text-sm">Receba notificações quando seu saldo estiver abaixo de um valor definido</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
                  type="checkbox"
