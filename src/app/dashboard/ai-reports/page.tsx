    ...
    <div className="space-y-6">
      ...
      >
        <div>
          ...
          <p className="text-zinc-400">Relatórios inteligentes gerados automaticamente pela IA</p>
        </div>
                ...
                <div className="flex-1">
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        {report.fileSize && (
                          <span className="text-xs text-zinc-400">{report.fileSize}</span>
                        )}
                      </div>
                  ...
                  {report.status === 'completed' && report.summary && (
                    <div className="bg-white/5 rounded-xl p-4 mb-4">
                      <h4 className="text-white font-medium mb-3">Resumo Executivo</h4>
                ...
                <div className="flex items-center gap-2 ml-4">
                  {report.status === 'completed' && (
                    <>
                      ...
                      <button className="p-2 hover:bg-white/10 rounded-lg transition-colors text-zinc-400 hover:text-green-400">
                        <Download className="w-4 h-4" />
                      </button>
                      <button className="p-2 hover:bg-white/10 rounded-lg transition-colors text-zinc-400 hover:text-purple-400">
      ...
      {filteredReports.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-zinc-400 text-lg">Nenhum relatório encontrado</p>
